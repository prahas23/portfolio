...
export default function Model(props) {
  ...
  const group = useRef()
   ...
   const videoTexture = useVideoTexture(props.texture || `${import.meta.env.BASE_URL}textures/project/project1.mp4`, {
    loop: true,
    muted: true,
    playsInline: true,
    start: true,
  ...
  videoTexture.wrapS = videoTexture.wrapT = THREE.ClampToEdgeWrapping
   ...
   videoTexture.repeat.set(2, 4.35)
  videoTexture.offset.set(0.12, 3.64)
