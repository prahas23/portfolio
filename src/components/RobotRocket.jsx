...
export default function RobotRocket(props) {
    const group = useRef()
    const { nodes, materials, animations } = useGLTF(`${import.meta.env.BASE_URL}models/robot_rocket.glb`)
...
useGLTF.preload(`${import.meta.env.BASE_URL}models/robot_rocket.glb`)
